    ...
    <div class="flex justify-start items-center gap-2 title">
        ...
        >
            <path id="SvgjsPath3009"
                  ...
                  data-name="Layer 9" fill="url(&quot;#SvgjsLinearGradient3010&quot;)">

            </path>
            <defs>
                <linearGradient gradientTransform="rotate(0 0.5 0.5)" id="SvgjsLinearGradient3010">
                    <stop stop-opacity=" 1" stop-color="rgba(125, 81, 146)" offset="0"
                          data-darkreader-inline-stopcolor="" style="--darkreader-inline-stopcolor: #644175;">

                    </stop>
                    <stop stop-opacity=" 1" stop-color="rgba(125, 81, 146)" offset="0.48"
                          data-darkreader-inline-stopcolor="" style="--darkreader-inline-stopcolor: #644175;">

                    </stop>
                    <stop stop-opacity=" 1" stop-color="rgba(128, 5, 166)" offset="1"
                          data-darkreader-inline-stopcolor="" style="--darkreader-inline-stopcolor: #660485;">
